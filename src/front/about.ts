...
const AboutPageContent = html`
  <div class="max-w-4xl mx-auto p-4">
    ...
    <p class="text-lg leading-relaxed mb-4">
      تمامی داده‌های ارسالی و دریافتی بین کاربران و سرورها با استفاده از
      پروتکل‌های امن HTTPS منتقل می‌شوند تا هیچ فرد ثالثی نتواند به داده‌های شما
      دسترسی پیدا کند. همچنین، برای جلوگیری از حملات سایبری و سوءاستفاده‌های
      احتمالی، نِکونیموس از مکانیزم‌های امنیتی متنوعی بهره می‌برد.
    </p>
